              ...
              for (const item of data) {
                try {
                  ...
                  const equipmentData = {
                    ...
                    purchaseDate: columnMap.purchaseDate ? item[columnMap.purchaseDate] : null,
    ...
    <div className="mb-8">
      ...
      <div className="mb-4">
        ...
        <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
          The CSV file must include columns for name, type, and serialNumber (required). Optional columns: condition, purchaseDate, notes.
        </p>
      </div>
